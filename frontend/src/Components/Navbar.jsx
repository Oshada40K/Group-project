    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
                ...
                {/* New Returns and Refunds NavLink */}
            ...
            <div className={`fixed top-0 right-0 h-full bg-white transition-all duration-300 ease-in-out ${visible ? 'w-full' : 'w-0 overflow-hidden'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    {/* New Returns and Refunds in Sidebar */}
                    <NavLink onClick={() => setVisible(false)} className='py-4 px-6 border-b hover:bg-gray-100' to='/return'>RETURNS & REFUNDS</NavLink>
                </div>
            </div>
        </div>
    );
